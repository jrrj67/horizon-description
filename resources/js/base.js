...
export default {
    ...
    methods: {
        ...
        /**
         * Unserialize data and return description
         */
        getJobDescription(serializedData)
        {
            var unserializedDate = phpunserialize(serializedData);

            return unserializedDate.description;
        }
    },
};
